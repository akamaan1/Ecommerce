        ...
        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                    ...
                    <p class="card-text font-size-14 text-black-50 py-1">Samsung Galaxy S23 Ultra May Get Custom 200-Megapixel Sensor, Sunny Optical Joins Supply Chain: Reports.</p>
